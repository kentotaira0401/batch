			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse"
					...
					<p class="navbar-text navbar-right">
						...
						<a href="${pageContext.request.contextPath}/showOrderHistory/paidOrderHistory" class="navbar-link">入金済み注文履歴</a>&nbsp;&nbsp;
			...
			<div
				...
				<table class="table table-striped">
					<tbody>
						...
						<c:forEach var="no-payment-order" items="${notPaymentOrderList}">
						<tr>
							<td>
								<span class="price">&nbsp;<c:out value="${no-payment-order.orderDate}"/></span>
							</td>
							<c:forEach var="orderItem" items="${no-payment-order.orderItemList}">
							<td>
								<div class="center">
