			...
			<div class="col-lg-offset-3 col-lg-6 col-md-offset-2 col-md-8 col-sm-10 col-xs-12">
				<div class="well">
					<div class="error"><c:out value="${loginError}"  /></div>
						...
						<form:form modelAttribute="rePasswordForm" action="${pageContext.request.contextPath}/register/rePass">
							<fieldset>
								<legend>
									パスワードを忘れた方
								</legend>
								...
								</div><font color="red">※メールアドレスが分からない場合は再登録となります。ご了承ください</font>
							</fieldset>
						</form:form>
				</div>
			</div>
